...
const AddDog = () => {
  ...
  const breedOptions = [
    ...
    { value: 68, label: "Bouviers des Flandre" },
    { value: 69, label: "Boxer" },
    { value: 70, label: "Boykin Spaniel" },
    { value: 71, label: "Brittany" },
    { value: 72, label: "Brussels Griffon" },
    { value: 73, label: "Bull Terrier" },
    { value: 74, label: "Bulldog" },
    { value: 75, label: "Bullmastiff" },
    { value: 76, label: "Cairn Terrier" },
    { value: 77, label: "Cane Corso" },
    { value: 78, label: "Cardigan Welsh Corgi" },
    { value: 79, label: "Cavalier King Charles Spaniel" },
    { value: 80, label: "Chesapeake Bay Retriever" },
    { value: 81, label: "Chihuahua" },
    { value: 82, label: "Chinese Crested" },
    { value: 83, label: "Chinese Shar-Pei" },
    { value: 84, label: "Chow Chow" },
    { value: 85, label: "Cocker Spaniel" },
    { value: 86, label: "Collie" },
    { value: 87, label: "Cotons de Tulear" },
    { value: 88, label: "Dachshund" },
    { value: 89, label: "Dalmatian" },
    { value: 90, label: "Doberman Pinscher" },
    { value: 91, label: "Dogo Argentino" },
    { value: 92, label: "Dogues de Bordeaux" },
    { value: 93, label: "English Cocker Spaniel" },
    { value: 94, label: "English Setter" },
    { value: 95, label: "English Springer Spaniel" },
    { value: 96, label: "French Bulldog" },
    { value: 97, label: "German Shepherd" },
    { value: 98, label: "German Shorthaired Pointer" },
    { value: 99, label: "Giant Schnauzer" },
    { value: 100, label: "Mixed" },
    { value: 101, label: "Mixed" },
